...
#         global send_pkg
#         msg = String()
#         msg.data = '{ "id": "RoverJ8", "type": "terrestre", "lat": "%s", "lon": "%s", "speed": "%s"}' % (send_pkg['lat'], send_pkg['lon'], send_pkg['speed'])
...
class nDron01(Node):
    ...
    def listener_callback(self, msg):
        ...
        self.get_logger().info('X3: %0.8f - Y3: %0.8f' % (msg.latitude, msg.longitude))
        datos = String()
        datos.data = '{ "id": "DeepRoboticsDog", "lat": "%0.8f", "lon": "%0.8f"}' % (msg.latitude, msg.longitude)
