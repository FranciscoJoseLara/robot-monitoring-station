#
#   Node that synchronize the publication of data from a unit of the system every 500 ms
#
...
class nTimerTest(Node):
    ...
    def __init__(self):
        ...
        self.subscription05 = self.create_subscription(
            ...
            10)
        self.timer = self.create_timer(0.5, self.publish_data)  # Timer every 500 ms
